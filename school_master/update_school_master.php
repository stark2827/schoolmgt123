...
if (isset($_POST['School_id']) && isset($_POST['School_name']) && isset($_POST['School_Address']) && isset($_POST['School_Image']) 
&& isset($_POST['School_phonNo']) && isset($_POST['School_Class_Image']) && isset($_POST['School_Library_Image']) && isset($_POST['School_Lab_Image'])) {
   ...
   // include db connect school_master
	...
	$result = mysql_query("UPDATE school_master SET School_name = '$School_name', School_Address = '$School_Address', School_Image = '$School_Image',
School_phonNo = '$School_phonNo', School_Class_Image = '$School_Class_Image', School_Library_Image = '$School_Library_Image', School_Lab_Image = '$School_Lab_Image'	WHERE School_id = $School_id");

...
if(isset($_POST['Class_division']) && isset($_POST['Class_name']))  
 {
 ...
 $result = mysql_query("SELECT Exam_Date, Exam_name, c.Class_name, c.Class_division, su.Subject_name, Chapters, Start_time, End_time, Total_marks FROM exam_master e 
	...
	JOIN subject_master su ON e.Subject_id = su.Subject_id   WHERE Class_name = '$Class_name' AND Class_division='$Class_division'");

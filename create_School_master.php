...
&& isset($_POST['School_phonNo'])) {
    ...
    $result = mysql_query("INSERT INTO school_master(School_name, School_Address, School_Image, 
	School_phonNo, School_Class_Image, School_Library_Image , School_Lab_Image  ) 
							VALUES('$School_name', '$School_Address', '$School_Image ', 
							'$School_phonNo', '$School_Class_Image', '$School_Library_Image ', '$School_Lab_Image')");
